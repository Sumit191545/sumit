...
<html>
    ...
    <body>
    <nav class="navbar navbar-expand-lg nav_style pl-3">
  <a class="navbar-brand pl-6" href="#">COVID-19</a>
...
<div class="main_header">
    <div class="row w-100 h-100">
        ...
        <div class="col-lg-7 col-md-7 col-12 order-lg-2 order-1">
            ...
            src="images/coronago.png" width="80" height="80"> </span>na Virus</h1>
            </div>
...
<section class="corona_update">
  <div class="mb-3">
    ...
    <div class="d-flex justify-content-around align-items-center count_style" >
        <div>
          <h1 class="count">971475</h1>
          <p>Total COVID-19 cases*</p>
        </div>
        <div>
         <h1 class="count">930607</h1>
          <p>Recovered</p>
        </div>


        <div>
          <h1 class="count">11864</h1>
          <p>Deaths</p>
        </div>
    </div>
</section>
        ...
        <div class="col-lg-5 col-md-6 col-12 about_res">
          ...
          <div class="col-lg-6 col-md-6 col-12">
            ...
            <p>COVID-19 is the infectious disease caused by the most 
              recently discoverded coronavirus.This new virus and disease 
        ...
        <div class= "container">
            <div class="row">
                <div class ="col-lg-4 col-md-4 col-12 mt-5">
                    ...
                    <img src="images/cough.jpg" class="img-fluid" width="120" 
                    height="120">
                ...
                <div class ="col-lg-4 col-md-4 col-12 mt-5">
                    <figure class="text-center">
                    <img src="images/runnynose.jpg" class="img-fluid" width="120" 
                    height="120">
                ...
                <div class ="col-lg-4 col-md-4 col-12 mt-5">
                    <figure class="text-center">
                    <img src="images/sneeze.jpg" class="img-fluid" width="120" 
                    height="120">
                    <figcaption> sneeze </figcaption>
                    </figure>
                </div> 
                <div class ="col-lg-4 col-md-4 col-12 mt-5">
                    <figure class="text-center">
                    <img src="images/tiredness.jpg" class="img-fluid" width="120" 
                    height="120">
                ...
                <div class ="col-lg-4 col-md-4 col-12 mt-5">
                    <figure class="text-center">
                    <img src="images/breathig.jpg" class="img-fluid" width="120" 
                    height="120">
      ...
      <div class="section_header text-center mb-5 mt-4">
       ...
       <div class="container">
           <div class="row">
               <div class="col-lg-4 col-md-4 col-12 mt-5">
                   <div class="row">
                       <div classa="col-lg-4 col-md-4 col-12">
                       <figure>
                    <img src="images/handwash.gif" class="img-fluid" width="90" 
                    height="90">
                        </figure>
                       </div>
                       <div class="col-lg-8 col-md-8 col-12">
                       <p> Wash your hands regularly for 20 
                        seconds with soap and water or alcohol-based hand rub.
                      </p>
                       </div>
                   </div>
               </div>
               ...
               <div class="col-lg-4 col-md-4 col-12 mt-5">
                   <div class="row">
                       ...
                       <figure>
                    <img src="images/wearmask.jpg" class="img-fluid" width="90" 
                    height="90">
                        </figure>
                       </div>
                       <div class="col-lg-8 col-md-8 col-12">
                       <p> Cover your nose and mouth with a disposable tissue or fiexed 
               ...
               <div class="col-lg-4 col-md-4 col-12 mt-5">
                   <div class="row">
                       <div class="col-lg-4 col-md-4 col-12">
                       <figure>
                    <img src="images/socialdistance.jpg" class="img-fluid" width="90" 
                    height="90">
                        </figure>
                       </div>
                       <div class="col-lg-8 col-md-8 col-12">
                       <p> Avoid close contact(1 meter or three feet)
               ...
               <div class="col-lg-4 col-md-4 col-12 mt-5">
                   <div class="row">
                       <div class="col-lg-4 col-md-4 col-12">
                       <figure>
                    <img src="images/stayhome.jpg" class="img-fluid" width="90" 
                    height="90">
                        </figure>
                       </div>
                       <div class="col-lg-8 col-md-8 col-12">
               ...
               <div class="col-lg-4 col-md-4 col-12 mt-5">
                   <div class="row">
                       <div class="col-lg-4 col-md-4 col-12">
                       <figure>
                    <img src="images/news.jpg" class="img-fluid" width="90" 
                    height="90">
                        </figure>
                       </div>
                       <div class="col-lg-8 col-md-8 col-12">
                       <p> Stay informed by watching 
                         news and follow the recommended practices.
                      </p>
                       </div>
                   </div>
               </div>
               ...
               <div class="col-lg-4 col-md-4 col-12 mt-5">
                   <div class="row">
                       <div class="col-lg-4 col-md-4 col-12">
                       <figure>
                    <img src="images/patient.jpg" class="img-fluid" width="90" 
                    height="90">
                        </figure>
                       </div>
                       <div class="col-lg-8 col-md-8 col-12">
...
<div class="container-fluid  pt-5 pb-5 mt-5" id="contactid">
  <div class="section_header text-center mb-5">
    <h1 class="text-capatalize"> Contact Us</h1>
  </div>
         ...
         <div class="row">
           ...
           <form action="" method="POST"> 
                  ...
                  <div class ="form-group">
                    ...
                    <lable><input type="checkbox" id="checkbox1" name="coronasym[]" value="Cold">Cold</lable><br/>
                    <lable><input type="checkbox" id="checkbox2" name="coronasym[]" value="Fever"> Fever</lable><br/>
                    <lable><input type="checkbox" id="checkbox3" name="coronasym[]" value="Difficulty in Breathing">Difficulty in Breathing</lable><br/>
                    <lable><input type="checkbox" id="checkbox4" name="coronasym[]" value="Feeling week"> Feeling week</lable>
                  </div>
                  <div class="form-group">
